...
//   return (
//     <div>
//       <div className="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md w-95">
...
//             <input
//               type="text"
//               className="mt-1 w-full p-2 border border-gray-300 rounded-md text-black-100"
//               name="dep_name"
...
//           <button
//             type="submit"
//             className="w-full mt-6 bg-teal-600 hove:bg-teal-700 text-white font-bold py-2 px-4 rounded"
//           >
//             Add Department
//           </button>
//         </form>
