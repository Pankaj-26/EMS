      ...
      <div className="flex space-x-3 mb-5">
        ...
        {leave.status==="Pending"? (
            <div className='flex space-x-2'>
                <button className='px-02 py-0.5 bg-teal-300 hover:bg-teal-4oo'onClick={()=>changeStatus(leave._id,"Approved")} >Approve</button>
                <button  className='px-02 py-0.5 bg-teal-300 hover:bg-red-4oo' onClick={()=>changeStatus(leave._id,"Rejected")}>Reject</button>
